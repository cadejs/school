...
ALTER TABLE play_job
    ADD CONSTRAINT job_pk PRIMARY KEY ( play_play_id,
                                        member_member_id,
                                        year );
...
ALTER TABLE play_location ADD CONSTRAINT location_pk PRIMARY KEY ( location_id );
...
ALTER TABLE play_member ADD CONSTRAINT member_pk PRIMARY KEY ( member_id );
...
ALTER TABLE due
    ADD CONSTRAINT due_member_fk FOREIGN KEY ( member_member_id )
        REFERENCES play_member ( member_id );

ALTER TABLE play_job
    ADD CONSTRAINT job_member_fk FOREIGN KEY ( member_member_id )
        REFERENCES play_member ( member_id );

ALTER TABLE play_job
    ADD CONSTRAINT job_play_fk FOREIGN KEY ( play_play_id )
        REFERENCES play ( play_id );

ALTER TABLE play_location
    ADD CONSTRAINT location_play_fk FOREIGN KEY ( play_play_id )
        REFERENCES play ( play_id );
